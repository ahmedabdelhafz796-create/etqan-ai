...
def fig_25_01():
    ...
    specs = [
        ...
        ("الرجل المشنوق (Hanging Man)", [(0, 3.0, 3.1, 1.0, 2.7)]),
        ("النجمة الساقطة (Shooting Star)", [(0, 2.3, 4.5, 2.2, 2.6)]),
        ("المغزل (Spinning Top)", [(0, 2.4, 4.0, 1.0, 2.7)]),
        ("الدوجي (Doji)", [(0, 2.5, 4.0, 1.0, 2.55)]),
        ("ماروبوزو (Marubozu)", [(0, 1.0, 4.0, 1.0, 4.0)]),
    ]
